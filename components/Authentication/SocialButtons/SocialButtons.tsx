...
export function DiscordButton(props: ButtonProps) {
  return <Button leftIcon={<DiscordIcon size={16} />} variant="default" color="gray" {...props} />;
}

export function MailButton(props: ButtonProps) {
  return <Button leftIcon={<IconMail size={16} />} variant="default" color="gray" {...props} />;
}
